    ...
    <div className={`modal-overlay ${isAddSuccess ? 'active': ''}`}>
      <div className="success-modal">
        <div className="modal__icon modal__icon--animate">
          <span class="modal-line modal-tip animate-success"></span>
          <span class="modal-line modal-long animate-success--long"></span>
        ...
        <div className="modal__footer">
          <button onClick={() => toggleSuccessModal(!isAddSuccess)} className="modal-btn">OK</button>
        </div>
      </div>
    </div>
  )
